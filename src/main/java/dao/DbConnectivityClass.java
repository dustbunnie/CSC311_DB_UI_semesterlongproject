...
public class DbConnectivityClass {
    final static String DB_NAME="CSC311_BD_TEMP";
        ...
        final static String SQL_SERVER_URL = "jdbc:mysql://csc311courseserver123123.mariadb.database.azure.com";//update this server name
        final static String DB_URL = "jdbc:mysql://csc311courseserver123123.mariadb.database.azure.com/"+DB_NAME;//update this database name
        final static String USERNAME = "csc311admin@csc311courseserver123123";// update this username
        final static String PASSWORD = "E1m2ilyg!";// update this password
